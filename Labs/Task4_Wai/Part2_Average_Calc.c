...
double Average(int hw_num){
    ...
    { 
      //each column have 1 empty spqce in front, and the gap of each number(XXX) is 4,
      //each col size is 41, as j increases the pointer will jump to the next line of the matrix
